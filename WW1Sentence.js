...
//ENTER NOUN FORMS HERE AND VERBS LATER. CONSIDER MOVING VERBS HERE!
const nounList = [["bestia","bestiae","f","beast","beasts"],["latrina","latrinae","f","bathroom","bathrooms"],["ianua","ianuae","f","door","doors"],["dominus","domini", "m", "master", "masters"],["puer","pueri", "m", "boy", "boys"],["magister","magistri", "m", "teacher", "teachers"],["amicus","amici", "m", "friend", "friends"],["coquus","coqui", "m", "cook", "cooks"],["filius","filii", "m","son","sons"],["servus","servi","m","slave","slaves"],["uxor","uxoris","f","wife","wives"],["frater","fratris","m","brother","brothers"],["hospes","hospitis", "m","guest","guests"],["corpus","corporis", "n","body","bodies"],["vulnus","vulneris", "n","wound","wounds"],["manus","manus", "f","hand","hands"],["senatus","senatus", "m","senate","senates"],["dies","diei", "m","day","days"],["res","rei", "f","thing","things"]];

var subject = [["labor","Work"],["nihil","Nothing"],["rumor","Gossip"],["Apollo","Apollo"]];
var rsi = Math.floor(Math.random() * subject.length);

var object = [["mē","me"],["nihil","nothing"]];
var roi = Math.floor(Math.random() * object.length);

var adverb = [["saepe", "often"],["lente","slowly"]];
var rai = Math.floor(Math.random() * adverb.length);

var personalEnding = [["eō","I"],["ēs","you"],["et","he"],["ēmus","we"],["ētis","ya'll"],["ent","they"]];
var rpi = Math.floor(Math.random() * personalEnding.length);
...
let verbList = [["culpo", "culpare", "culpavi","culpatus", "blame", "blaming", "blamed", "blamed"],["amo", "amare", "amavi","amatus", "love", "loving", "loved", "loved"],["cogito", "cogitare", "cogitavi","cogitatus", "think", "thinking", "thought", "thought"],["debeo", "debēre", "debui","debitus", "owe", "owed", "owed", "ought"],["moneo", "monēre", "monui","monitus", "warn", "warning", "warned", "advised"],["terreo", "terrēre", "terrui","territus", "frighten", "frightening", "terrified", "frightened"],["erro", "errare", "erravi","erratus", "err", "wandering", "made a mistake", "been mistaken"],["servo", "servare", "servavi","servatus", "guard", "saving", "kept", "preserved"],["conservo", "conservare", "conservavi","conservatus", "preserve", "conserving", "maintained", "preserved"],["voco", "vocare", "vocavi","vocatus", "call", "summoning", "called", "summoned"],["pulso", "pulsare", "pulsavi","pulsatus", "strike", "striking", "struck", "struck"],["do", "dare", "dēdi","datus", "give", "giving", "gave", "given"],["video", "vidēre", "vīdi","visus", "see", "seeing", "saw", "seen"],["duco", "ducere", "duxi","ductus", "lead", "leading", "led", "led"],
...
var rn2i = Math.floor(Math.random() * nounList.length);
var myNoun2 = new Noun(nounList[rn2i][0],nounList[rn2i][1],nounList[rn2i][2],nounList[rn2i][3],nounList[rn2i][4]);
...
//Noun Reset
  ...
  rn2i = Math.floor(Math.random() * nounList.length);
  myNoun2 = new Noun(nounList[rn2i][0],nounList[rn2i][1],nounList[rn2i][2],nounList[rn2i][3],nounList[rn2i][4]);

  subject = [["labor","Work"],["nihil","Nothing"],["rumor","Gossip"],["Apollo","Apollo"]];
  rsi = Math.floor(Math.random() * subject.length);

  object = [["mē","me"],["nihil","nothing"]];
  roi = Math.floor(Math.random() * object.length);

  adverb = [["saepe", "often"],["lente","slowly"]];
  rai = Math.floor(Math.random() * adverb.length);

  personalEnding = [["eō","I"],["ēs","you"],["et","he"],["ēmus","we"],["ētis","ya'll"],["ent","they"]];
  rpi = Math.floor(Math.random() * personalEnding.length);
...
//This ensures that all verbs are used before it is repeated.
  ...
  if (verbList.length ==0){
    verbList = [["culpo", "culpare", "culpavi","culpatus", "blame", "blaming", "blamed", "blamed"],["amo", "amare", "amavi","amatus", "love", "loving", "loved", "loved"],["cogito", "cogitare", "cogitavi","cogitatus", "think", "thinking", "thought", "thought"],["debeo", "debēre", "debui","debitus", "owe", "owed", "owed", "ought"],["moneo", "monēre", "monui","monitus", "warn", "warning", "warned", "advised"],["terreo", "terrēre", "terrui","territus", "frighten", "frightening", "terrified", "frightened"],["erro", "errare", "erravi","erratus", "err", "wandering", "made a mistake", "been mistaken"],["servo", "servare", "servavi","servatus", "guard", "saving", "kept", "preserved"],["conservo", "conservare", "conservavi","conservatus", "preserve", "conserving", "maintained", "preserved"],["voco", "vocare", "vocavi","vocatus", "call", "summoning", "called", "summoned"],["pulso", "pulsare", "pulsavi","pulsatus", "strike", "striking", "struck", "struck"],["do", "dare", "dēdi","datus", "give", "giving", "gave", "given"],["video", "vidēre", "vīdi","visus", "see", "seeing", "saw", "seen"],["duco", "ducere", "duxi","ductus", "lead", "leading", "led", "led"],
    ["capio", "capere", "cēpi","captus", "capture", "capturing", "captured", "captured"],["audio", "audire", "audivi","auditus", "hear", "hearing", "heard", "heard"],["facio", "facere", "fēci","factus", "make", "making", "made", "made"]];
}

//This is where you create your sentences!


  sentenceArray = [["Valē! Quid " + myVerb.secondSingPres +"?", "Good-bye! What do you " + myVerb.verb + "?"],["Salvēte! Quid " + myVerb.secondPlPres +"?", "Hello! What do ya'll " + myVerb.verb + "?"],["Quid " + myVerb.secondPlPres + "? Nihil saepe " + myVerb.firstPlPres,"What do " + myVerb.secondPlPresTrans + "?  We often " + myVerb.verb + " nothing"],[myVerb.secondSingPres + " " + object[roi][0] + ", " + myVerb2.thirdPlPres + " " + object[roi][0],"You " + myVerb.verb + " " + object[roi][1] + "; they " + myVerb2.verb + " " + object[roi][1]],["Quid " + myVerb.secondSingPres + "?","What do " + myVerb.secondSingPresTrans +"?"],[myVerb.imperativeSing + " " + object[roi][0] + " si te non " + myVerb2.firstSingPres, myVerb.imperativeSingTrans + " " + object[roi][1] + " if I do not " + myVerb2.verb + " you."],["Si " + object[roi][0] + " " + myVerb.thirdSingPres + ", te " + myVerb2.firstSingPres, "If " + myVerb.thirdSingPresTrans + " " + object[roi][1] + ", " + myVerb2.firstSingPresTrans + " you"],["Sī " + myVerb.secondSingPres + ",  valeō", "If " + myVerb.secondSingPresTrans + ", I am well."],["Quid deb" + personalEnding[rpi][0] + " " + myVerb.actInfPres + "?", "What ought " + personalEnding[rpi][1] + " " + myVerb.actInfPresTrans + "?" ],[subject[rsi][0] + " " + object[roi][0] + " " + myVerb.thirdSingPres, subject[rsi][1] + " " + myVerb.thirdSingPresTrans2 +  " " + object[roi][1]]];
  shuffle(sentenceArray)

  /*
  ,[myNoun.vocativeSing + ", " + myVerb.imperativeSing + " " + myNoun2.accusativeSing + "!",myNoun.vocativeSingTrans + ", " + myVerb.imperativeSingTrans + " " + myNoun2.accusativeSingTrans + "!"],[myNoun.nominativeSing + " " + myNoun2.accusativeSing + " " + myVerb.thirdSingPer,myNoun.nominativeSingTrans + " " + myVerb.thirdSingPerTrans2  + " " + myNoun2.accusativeSingTrans],[myNoun2.nominativeSing + " " + myNoun.accusativeSing + " " + myVerb.thirdSingPer,myNoun2.nominativeSingTrans + " " + myVerb.thirdSingPerTrans2 + " " + myNoun.accusativeSingTrans],[myNoun.nominativeSing + " " + myNoun.accusativeSing + " " +myVerb.thirdSingPres,myNoun.nominativeSingTrans + " " + myVerb.thirdSingPresTrans2+ " " + myNoun.accusativeSingTrans],[myNoun2.nominativeSing + " " + myNoun.accusativeSing + " " + myVerb.thirdSingPres,myNoun2.nominativeSingTrans + " " +myVerb.thirdSingPresTrans2 + " " + myNoun.accusativeSingTrans]
  */
